...
- A completed 20-hour claim should include the `ulm:literal-run-readiness --strict --json` result in the operator handoff so a later reviewer can distinguish "ready to run" from "proved by wall clock."
