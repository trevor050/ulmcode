...
- `operation_resume` emits a compact post-compaction/restart brief with health gaps, recommended tools, active/background tasks, and a continuation prompt before raw JSON.
