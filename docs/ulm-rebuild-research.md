...
- Broader vulnerable-target lab catalog. The catalog now has weak-MFA, roster-IDOR, gradebook mass-assignment, and storage/config leak scenarios with Docker Compose support, but still needs injection and reporting-quality cases.
