...
- Persistent live-updating TUI operation route. The TUI now has a native operation dialog, but not a pinned full-screen route that streams operation/background-task changes without reopening or refreshing.
