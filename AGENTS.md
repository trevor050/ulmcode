...
- For overnight-supervisor work, read `docs/superpowers/plans/2026-05-06-ulm-overnight-supervisor.md` before editing. It is the durable compaction-resume plan for the supervisor/goal/tool-inventory rebuild.
