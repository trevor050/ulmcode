...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "ULMCode에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 ULMCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 ULMCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 ULMCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 ULMCode 서버를 전환합니다.",
  ...
  "toast.update.description": "ULMCode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 ULMCode 팀에 제보해 주세요: ",
  ...
  "sidebar.gettingStarted.line1": "ULMCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "ULMCode 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 ULMCode가 보이는 방식 사용자 지정",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "ULMCode 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "ULMCode를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 ULMCode를 사용 중입니다.",
