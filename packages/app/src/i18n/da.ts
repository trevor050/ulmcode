export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af ULMCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i ULMCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "ULMCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i ULMCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i ULMCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i ulmcode.json",
  ...
  "dialog.server.description": "Skift hvilken ULMCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af ULMCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til ULMCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (ulmcode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, ULMCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "ULMCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for ULMCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan ULMCode ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan ULMCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når ULMCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af ULMCode.",
