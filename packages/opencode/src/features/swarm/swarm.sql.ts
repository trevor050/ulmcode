...
export const SwarmTaskTable = sqliteTable(
  "swarm_task",
  {
    ...
    swarm_aggression: text().notNull().$default(() => "balanced"),
    aggression_source: text().notNull().$default(() => "default"),
    max_active_background: integer(),
    max_delegation_depth: integer().notNull().$default(() => 2),
