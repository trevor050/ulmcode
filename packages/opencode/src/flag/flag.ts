...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_SWARM_V2_1 = OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_SWARM_V2_1")
  export const OPENCODE_EXPERIMENTAL_SWARM_V2_1_DEFAULT_AGGRESSION = process.env[
    "OPENCODE_EXPERIMENTAL_SWARM_V2_1_DEFAULT_AGGRESSION"
  ]
  export const OPENCODE_EXPERIMENTAL_SWARM_V2_1_ASK_AGGRESSION_ON_PLAN_EXIT = truthy(
    "OPENCODE_EXPERIMENTAL_SWARM_V2_1_ASK_AGGRESSION_ON_PLAN_EXIT",
  )
  export const OPENCODE_EXPERIMENTAL_SWARM_V2_1_MAX_PARALLEL_DEPTH_CAP = number(
    "OPENCODE_EXPERIMENTAL_SWARM_V2_1_MAX_PARALLEL_DEPTH_CAP",
  )
