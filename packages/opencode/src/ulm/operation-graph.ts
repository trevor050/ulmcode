...
const BASE_LANES: Array<Omit<OperationLane, "operationID" | "modelRoute" | "fallbackModelRoutes" | "budget" | "restartPolicy" | "status"> & {
  ...
  },
  {
    ...
    agent: "evidence",
    dependsOn: ["recon", "web_inventory", "identity_auth_review", "saas_cloud_review"],
  ...
  },
  {
    ...
    allowedTools: ["runtime_summary", "operation_audit", "operation_checkpoint"],
    expectedArtifacts: ["deliverables/final/operator-review.md", "deliverables/final/runtime-summary.md", "deliverables/final/README.md"],
    route: "reasoning",
    budgetWeight: 0.02,
