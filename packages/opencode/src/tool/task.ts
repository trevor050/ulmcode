      ...
      const envBlock =
        environment?.type === "cyber"
          ? [
              ...
              "Own one bounded lane only. Stay inside your assigned host/service/path/research lane unless the parent explicitly widens scope.",
              ...
              "Before finishing, explicitly list what remains unexplored inside your lane and what follow-up is still justified by evidence.",
